...
def main(args):
    ...
    for step in range(args.n_steps):
        ...
        if args.sample == True:
            ...
            with torch.no_grad():
                action= policy.act(torchify(obs), deterministic=True, exp_prob=exp_prob, noise=args.noise, sample=False)         
...
if __name__ == '__main__':
    ...
    parser.add_argument('--static-exp-prob',action='store_true')
