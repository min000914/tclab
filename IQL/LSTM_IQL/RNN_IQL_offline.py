...
from src.RNN_policy import RNNPolicy
...
def main(args):
    ...
    policy = RNNPolicy(obs_dim, act_dim, hidden_dim=args.hidden_dim, rnn_layers=args.lstm_layers, normalization=args.act_normalization).to(device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--simmul', action='store_true')
    ...
    parser.add_argument('--act-normalization',action='store_true')
